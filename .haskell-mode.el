...
;; to regenerate this.
;; 
;; I assume that the caller has already loaded haskell-site-file -sboles
;; (load "haskell-site-file")

;; Customization
(custom-set-variables
 ;; Use cabal-dev for the GHCi session. Ensures our dependencies are in scope.
 ;; If you don't have or don't want to use cabal-dev, change
 ;; haskell-process-type to 'ghci
